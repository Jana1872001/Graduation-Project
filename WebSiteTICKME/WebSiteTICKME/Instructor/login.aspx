 ...
 &nbsp;&nbsp;&nbsp;&nbsp;
          ...
          &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
               ...
               <asp:View ID="LogInYourEmailView" runat="server">
					 ...
					 <h1 class="auto-style1"> <span class="auto-style1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Instructor</span></h1>
                <asp:TextBox ID="IDTextBox"  runat="server" placeholder="Enter ID"  > </asp:TextBox> &nbsp;&nbsp;&nbsp;&nbsp;
 &nbsp;&nbsp;&nbsp;&nbsp;

                    <br />
                    <br />
                  <asp:TextBox ID="PassTextBox" runat="server" OnTextChanged="PassTextBox_TextChanged"  placeholder="Enter Password"  TextMode="Password" ></asp:TextBox>
          &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
