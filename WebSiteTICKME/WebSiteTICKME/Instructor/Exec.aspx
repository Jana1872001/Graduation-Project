<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Exec.aspx.cs" Inherits="Instructor_Exec" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Student Execusies</title>
	  ...
	  <div>
       <asp:Image ID="Image2" runat="server" ImageUrl="~/images/Tick.png" />
           ...
           <div>
             ...
             <asp:GridView ID="GridView1" runat="server"  AutoGenerateColumns="False" DataKeyNames="ID" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" Width="789px" Height="198px" CssClass="auto-style1" style="font-size: 20px">
                    ...
                    <asp:TemplateField HeaderText="Accept">
                        <ItemTemplate>
                            <asp:LinkButton ID="LinkButton2" runat="server" OnClick="AceptExec" Text="Accept"></asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>

                    <asp:TemplateField HeaderText="Reject">
                        <ItemTemplate>
                            <asp:LinkButton ID="LinkButton3" runat="server" OnClick="RejecttExec" Text="Reject"></asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
