	  ...
	  <div>
       <asp:Image ID="Image2" runat="server" ImageUrl="~/images/Tick.png" />
             ...
             <strong><asp:Label ID="Label1" runat="server"  CssClass="auto-style3"></asp:Label><br /><br />
                 <asp:Label ID="Label2" runat="server" CssClass="auto-style3" ></asp:Label><br /><br />
             ...
             <asp:GridView ID="GridView1" runat="server"  AutoGenerateColumns="False" DataKeyNames="id" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" Width="789px" Height="198px" CssClass="auto-style1" style="font-size: 20px">
                    ...
                    <asp:TemplateField HeaderText="Date">
                        <ItemTemplate>
                            <asp:label ID="Label5" runat="server"  Text='<%# Eval("dat", "{0:dd/MM/yyyy}") %>'></asp:label>
                        </ItemTemplate>
                    </asp:TemplateField>
                            <asp:TemplateField HeaderText="Delete">
                        <ItemTemplate>
                            <asp:LinkButton ID="LinkButton3" runat="server" OnClick="DeleteExec" Text="Delete"></asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
