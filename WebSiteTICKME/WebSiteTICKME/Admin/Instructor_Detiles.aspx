<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Instructor_Detiles.aspx.cs" Inherits="Admin_Instructor_Detiles" %>
    ...
    <li>
		<table>
			<tr>
				<td>ID</td>
				<td>
                    <asp:Label ID="Label2" runat="server" Text="Random ID"></asp:Label>	</td>
			</tr>
	     ...
	     <div >
             ...
             <li>
                 ...
                 <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="ID"
                     CellPadding="15" Font-Size="15px" AutoGenerateSelectButton="True" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                <Columns>
